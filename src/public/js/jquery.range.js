...
(function ($, window, document, undefined) {
  ...
  jRange.prototype = {
    ...
    render: function () {
      ...
      this.options.callback.call(this, this.options.value);
    },
    isSingle: function () {
    ...
    barClicked: function (e) {
      ...
      if (this.isSingle())
        ...
        var pointer =
          Math.abs(
            parseInt(this.pointers.first().css("left"), 10) -
              x +
              this.pointers.first().width() / 2
          ) <
          Math.abs(
            parseInt(this.pointers.last().css("left"), 10) -
              x +
              this.pointers.first().width() / 2
          )
            ? this.pointers.first()
    ...
    onChange: function (e, self, pointer, position) {
      ...
      if (self.isSingle()) {
        ...
        min = pointer.hasClass("high")
          ? self.lowPointer.position().left + self.lowPointer.width() / 2
          : 0;
        max = pointer.hasClass("low")
          ? self.highPointer.position().left + self.highPointer.width() / 2
          : self.domNode.width();
      }
