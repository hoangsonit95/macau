...
($.smVersion = "0.6.2"),
      ...
      (a.getTranslate = function (a, b) {
        ...
        return (
          ...
          window.WebKitCSSMatrix
            ? (f = new WebKitCSSMatrix(
                "none" === e.webkitTransform ? "" : e.webkitTransform
              ))
            : ((f =
                e.MozTransform ||
                e.transform ||
  ...
  (function (a) {
    ...
    if (
      ((b.ios = b.android = b.iphone = b.ipad = b.androidChrome = !1),
      d &&
        ((b.os = "android"),
        (b.osVersion = d[2]),
        (b.android = !0),
      ...
      b.ios &&
        ...
        (b.osVersion = c.toLowerCase().split("version/")[1].split(" ")[0]),
      ...
      b.minimalUi =
        !b.webView &&
        (f || g) &&
        (1 * h[0] === 7 ? 1 * h[1] >= 1 : 1 * h[0] > 7) &&
        a('meta[name="viewport"]').length > 0 &&
        a('meta[name="viewport"]').attr("content").indexOf("minimal-ui") >= 0;
    }
    var i = a(window).width(),
      j = a(window).height();
    (b.statusBar = !1),
      b.webView && i * j === screen.width * screen.height
        ? (b.statusBar = !0)
        : (b.statusBar = !1);
    var k = [];
    if (
      ...
      b.os &&
        (k.push(
          b.os,
          b.os + "-" + b.osVersion.split(".")[0],
          b.os + "-" + b.osVersion.replace(/\./g, "-")
        ),
        "ios" === b.os))
    )
      for (
        var l = parseInt(b.osVersion.split(".")[0], 10), m = l - 1;
        m >= 6;
        m--
      )
        k.push("ios-gt-" + m);
    b.statusBar
      ? k.push("with-statusbar-overlay")
      : a("html").removeClass("with-statusbar-overlay"),
  ...
  (function () {
    ...
    (a.prototype.needsClick = function (a) {
      for (var b = a; b && "BODY" !== b.tagName.toUpperCase(); ) {
        if (
          "LABEL" === b.tagName.toUpperCase() &&
          ((h = !0), /\bneedsclick\b/.test(b.className))
        )
          return !0;
        b = b.parentNode;
      }
      ...
      (a.prototype.determineEventType = function (a) {
        return c && "select" === a.tagName.toLowerCase()
          ? "mousedown"
          : "click";
      }),
      (a.prototype.focus = function (a) {
        ...
        d && a.setSelectionRange && -1 === c.indexOf(a.type)
      ...
      (a.prototype.onTouchStart = function (a) {
        ...
        return (
          ...
          a.timeStamp - this.lastClickTime < this.tapDelay &&
            a.preventDefault(),
          !0
        );
      }),
  ...
  +(function (a) {
    ...
    function b(b) {
      ...
      e.hasClass("open-popup") &&
        ((c = f.popup ? f.popup : ".popup"), a.popup(c)),
        e.hasClass("close-popup") &&
          ((c = f.popup ? f.popup : ".popup.modal-in"), a.closeModal(c)),
        e.hasClass("modal-overlay") &&
          (a(".modal.modal-in").length > 0 &&
            d.modalCloseByOutside &&
            a.closeModal(".modal.modal-in"),
          a(".actions-modal.modal-in").length > 0 &&
            d.actionsCloseByOutside &&
            a.closeModal(".actions-modal.modal-in")),
        e.hasClass("popup-overlay") &&
          a(".popup.modal-in").length > 0 &&
          d.popupCloseByOutside &&
          a.closeModal(".popup.modal-in");
    }
    ...
    (a.modalStack = []),
        ...
        if (b.buttons && b.buttons.length > 0)
          for (var g = 0; g < b.buttons.length; g++)
            f +=
              ...
              (b.buttons[g].bold ? " modal-button-bold" : "") +
              '">' +
              b.buttons[g].text +
              "</span>";
        var h = b.extraClass || "",
      ...
      (a.alert = function (b, c, e) {
        return (
          "function" == typeof c && ((e = arguments[1]), (c = void 0)),
          a.modal({
            text: b || "",
      ...
      (a.confirm = function (b, c, e, f) {
        return (
          "function" == typeof c &&
            ((f = arguments[2]), (e = arguments[1]), (c = void 0)),
          a.modal({
            text: b || "",
            title: "undefined" == typeof c ? d.modalTitle : c,
            buttons: [
              { text: d.modalButtonCancel, onClick: f },
              { text: d.modalButtonOk, bold: !0, onClick: e },
            ],
          })
        );
      }),
      ...
      (a.showIndicator = function () {
        a(".preloader-indicator-modal")[0] ||
          a(d.modalContainer).append(
        ...
        return (
          ...
          0 === b.length
            ...
            : (b.show(),
              ...
              b.find("." + d.viewClass).length > 0 &&
                a.sizeNavbars(b.find("." + d.viewClass)[0]),
              a.openModal(b),
              b[0])
        );
      }),
      (a.pickerModal = function (b, c) {
        ...
        return (
          (b = a(b)), 0 === b.length ? !1 : (b.show(), a.openModal(b), b[0])
        );
      }),
      ...
      (a.openModal = function (b, c) {
        ...
        var e = b.hasClass("modal"),
          f = !b.hasClass("toast");
        if (
          a(".modal.modal-in:not(.modal-out)").length &&
          d.modalStack &&
          e &&
          f
        )
        ...
        e &&
          (b.show(),
          b.css({ marginTop: -Math.round(b.outerHeight() / 2) + "px" })),
          j &&
            b.css({
        ...
        h ||
          i ||
          j ||
          (0 !== a(".modal-overlay").length ||
            g ||
            a(d.modalContainer).append('<div class="modal-overlay"></div>'),
          0 === a(".popup-overlay").length &&
            g &&
            a(d.modalContainer).append('<div class="popup-overlay"></div>'),
      ...
      (a.closeModal = function (b) {
        if (
          ((b = a(b || ".modal-in")), "undefined" == typeof b || 0 !== b.length)
        ) {
          ...
          return (
            e
              ? b.length === a(".popup.modal-in").length &&
                j.removeClass("modal-overlay-visible")
              : h || f || j.removeClass("modal-overlay-visible"),
            b.trigger("close"),
            h &&
              (a(d.modalContainer).removeClass("with-picker-modal"),
            ...
            b
              ...
              .transitionEnd(function (c) {
                b.hasClass("modal-out")
                  ...
                  e || g || h
                    ? (b.removeClass("modal-out").hide(),
                      i && b.length > 0 && b.remove())
                    : b.remove();
              }),
      ...
      c = function (c) {
        function d(a) {
          ...
          var b = a.getFullYear(),
            ...
            e = a.getDate(),
            f = a.getDay();
          return h.params.dateFormat
            .replace(/yyyy/g, b)
            .replace(/yy/g, (b + "").substring(2))
            .replace(/mm/g, 10 > d ? "0" + d : d)
            .replace(/m/g, d)
            .replace(/MM/g, h.params.monthNames[c])
            .replace(/M/g, h.params.monthNamesShort[c])
            .replace(/dd/g, 10 > e ? "0" + e : e)
            .replace(/d/g, e)
            .replace(/DD/g, h.params.dayNames[f])
            .replace(/D/g, h.params.dayNamesShort[f]);
        }
        function e(b) {
          if (
            (b.preventDefault(),
            ...
            !h.opened && (h.open(), h.params.scrollToInput))
          ) {
        ...
        function f(b) {
          h.input && h.input.length > 0
            ? b.target !== h.input[0] &&
              0 === a(b.target).parents(".picker-modal").length &&
              h.close()
            : 0 === a(b.target).parents(".picker-modal").length && h.close();
        }
        function g() {
          (h.opened = !1),
            h.input &&
              h.input.length > 0 &&
              h.input.parents(".content").css({ "padding-bottom": "" }),
        ...
        return (
          ...
          (h.addValue = function (a) {
            if (h.params.multiple) {
              ...
              for (var b, c = 0; c < h.value.length; c++)
                new Date(a).getTime() === new Date(h.value[c]).getTime() &&
                  (b = c);
          ...
          (h.updateValue = function () {
            ...
            if (
              (h.params.onChange &&
                h.params.onChange(h, h.value, h.value.map(d)),
              h.input && h.input.length > 0)
            ) {
          ...
          (h.initCalendarEvents = function () {
            ...
            function d(a) {
              if (n) {
                ...
                (C = !1),
                  o ||
                    ((o = !0),
                    (x = h.wrapper[0].offsetWidth),
                    (y = h.wrapper[0].offsetHeight),
                    h.wrapper.transition(0)),
                  a.preventDefault(),
                  (A = h.isH ? r - p : s - q),
                  (z = A / (h.isH ? x : y)),
                  (w = 100 * (h.monthsTranslate * k + z)),
                  h.wrapper.transform(
                    "translate3d(" +
                      (h.isH ? w : 0) +
                      "%, " +
            ...
            function f(b) {
              if (C) {
                ...
                if (
                  (0 === c.length &&
                    a(b.target).hasClass("picker-calendar-day") &&
                    (c = a(b.target)),
                  0 !== c.length &&
                    (!c.hasClass("picker-calendar-day-selected") ||
                      h.params.multiple) &&
                    !c.hasClass("picker-calendar-day-disabled"))
                ) {
            ...
            function i(a) {
              if (n) {
                ...
                (C = !1),
                  o ||
                    ((o = !0),
                    (x = h.yearsPickerWrapper[0].offsetWidth),
                    (y = h.yearsPickerWrapper[0].offsetHeight),
                    h.yearsPickerWrapper.transition(0)),
                  a.preventDefault(),
                  (A = h.isH ? r - p : s - q),
                  (z = A / (h.isH ? x : y)),
                  (w = 100 * (h.yearsTranslate * k + z)),
                  h.yearsPickerWrapper.transform(
                    "translate3d(" +
                      (h.isH ? w : 0) +
                      "%, " +
                      (h.isH ? 0 : w) +
            ...
            function l() {
              var b =
                (a(this).text(),
                h.container.find(".picker-calendar-years-picker"));
              b.show().transform("translate3d(0, 0, 0)"),
            ...
            function m() {
              ...
              a.show().transform("translate3d(0, 0, 0)"),
                h.updateSelectedInPickers(),
                a.on("click", ".picker-calendar-month-unit", h.pickMonth);
            }
            var n,
              o,
              p,
            ...
            h.container
              ...
              .on("click", h.prevMonth),
              h.container
                .find(".picker-calendar-next-month")
                .on("click", h.nextMonth),
              h.container
              ...
              h.container
                ...
                .on("click", h.nextYear),
              h.container.find(".current-year-value").on("click", l),
              h.container.find(".current-month-value").on("click", m),
              h.wrapper.on("click", f),
              h.params.touchMove &&
                (h.yearsPickerWrapper.on(a.touchEvents.start, g),
                h.yearsPickerWrapper.on(a.touchEvents.move, i),
                h.yearsPickerWrapper.on(a.touchEvents.end, j),
                h.wrapper.on(a.touchEvents.start, c),
                h.wrapper.on(a.touchEvents.move, d),
                h.wrapper.on(a.touchEvents.end, e)),
              (h.container[0].f7DestroyCalendarEvents = function () {
                h.container
                  .find(".picker-calendar-prev-month")
                  .off("click", h.prevMonth),
                  h.container
                    .find(".picker-calendar-next-month")
                    .off("click", h.nextMonth),
                  h.container
                    .find(".picker-calendar-prev-year")
                    .off("click", h.prevYear),
                  h.container
                    .find(".picker-calendar-next-year")
                    .off("click", h.nextYear),
                  h.wrapper.off("click", f),
                  h.params.touchMove &&
                    (h.wrapper.off(a.touchEvents.start, c),
                    h.wrapper.off(a.touchEvents.move, d),
                    h.wrapper.off(a.touchEvents.end, e));
              });
          }),
          (h.destroyCalendarEvents = function (a) {
            "f7DestroyCalendarEvents" in h.container[0] &&
              h.container[0].f7DestroyCalendarEvents();
          }),
          (h.yearsGroupHTML = function (a, b) {
            ...
            for (var h = 0; 5 > h; h += 1) {
              ...
              for (var j = 0; 5 > j; j += 1)
                (i +=
                  f === d
                    ? '<div class="picker-calendar-year-unit current-calendar-year-unit" data-year="' +
                      f +
                      '"><span>' +
                      f +
                      "</span></div>"
                    : f === c
                    ? '<div class="picker-calendar-year-unit picker-calendar-year-unit-selected" data-year="' +
                      f +
                      '"><span>' +
                      f +
                      "</span></div>"
                    : '<div class="picker-calendar-year-unit" data-year="' +
                      f +
                      '"><span>' +
                      f +
                      "</span></div>"),
            ...
            return (g =
              '<div class="picker-calendar-years-group">' + g + "</div>");
          }),
          (h.pickYear = function () {
            var b = a(this).text(),
              c = h.wrapper
                .find(".picker-calendar-month-current")
                .attr("data-year");
            h.yearsPickerWrapper
              .find(".picker-calendar-year-unit")
              .removeClass("picker-calendar-year-unit-selected"),
              a(this).addClass("picker-calendar-year-unit-selected"),
              c !== b
                ? (h.setYearMonth(b),
                  h.container
                    .find(".picker-calendar-years-picker")
                    .hide()
          ...
          (h.onYearsChangeEnd = function (a) {
            ...
            var b,
              c,
              d,
              e = h.yearsPickerWrapper
                .children(".picker-calendar-years-next")
                .find(".picker-calendar-year-unit").length;
            if ("next" === a) {
              var d = parseInt(
                h.yearsPickerWrapper
                  .children(".picker-calendar-years-next")
              ...
              (b = h.yearsGroupHTML(new Date(d, h.currentMonth), "next")),
                h.yearsPickerWrapper.append(b),
                h.yearsPickerWrapper.children().first().remove(),
                (h.yearsGroups = h.container.find(
            ...
            if ("prev" === a) {
              var d = parseInt(
                h.yearsPickerWrapper
                  .children(".picker-calendar-years-prev")
                  .find(".picker-calendar-year-unit")
                  .eq(Math.floor(e / 2))
                  .text()
              );
              (c = h.yearsGroupHTML(new Date(d, h.currentMonth), "prev")),
                h.yearsPickerWrapper.prepend(c),
                h.yearsPickerWrapper.children().last().remove(),
                (h.yearsGroups = h.container.find(
                  ".picker-calendar-years-group"
                ));
            }
          ...
          (h.monthsGroupHTML = function (a) {
            ...
            for (
              ...
              for (var i = 0; 4 > i; i += 1)
                (g +=
                  d === c
                    ? '<div class="picker-calendar-month-unit current-calendar-month-unit" data-month="' +
                      (d - 1) +
                      '"><span>' +
                      h.params.monthNames[d - 1] +
                      "</span></div>"
                    : d === b
                    ? '<div class="picker-calendar-month-unit picker-calendar-month-selected" data-month="' +
                      (d - 1) +
                      '"><span>' +
                      h.params.monthNames[d - 1] +
                      "</span></div>"
                    : '<div class="picker-calendar-month-unit" data-month="' +
                      (d - 1) +
                      '"><span>' +
                      h.params.monthNames[d - 1] +
                      "</span></div>"),
            ...
            return (e =
              '<div class="picker-calendar-months-group">' + e + "</div>");
          }),
          (h.pickMonth = function () {
            var b = a(this).attr("data-month"),
              ...
              d = h.wrapper
                .find(".picker-calendar-month-current")
                .attr("data-month");
            h.monthsPickerWrapper
              .find(".picker-calendar-month-unit")
              .removeClass("picker-calendar-month-unit-selected"),
              a(this).addClass("picker-calendar-month-unit-selected"),
              d !== b
                ? (h.setYearMonth(c, b),
                  h.container
                    .find(".picker-calendar-months-picker")
                    .hide()
                    .transform("translate3d(0, 100%, 0)"))
                : h.container
                    .find(".picker-calendar-months-picker")
          ...
          (h.monthHTML = function (a, b) {
            ...
            a.getDate();
            "next" === b &&
              (a = 11 === d ? new Date(c + 1, 0) : new Date(c, d + 1, 1)),
              "prev" === b &&
                (a = 0 === d ? new Date(c - 1, 11) : new Date(c, d - 1, 1)),
              ("next" !== b && "prev" !== b) ||
                ((d = a.getMonth()), (c = a.getFullYear()));
            var e = h.daysInMonth(
                new Date(a.getFullYear(), a.getMonth()).getTime() - 864e6
              ),
              f = h.daysInMonth(a),
            ...
            var i,
              ...
              r = h.params.minDate
                ? new Date(h.params.minDate).getTime()
                : null,
              s = h.params.maxDate
                ? new Date(h.params.maxDate).getTime()
                : null;
          ...
          (h.updateCurrentMonthYear = function (a) {
            "undefined" == typeof a
              ? ((h.currentMonth = parseInt(
                  h.months.eq(1).attr("data-month"),
                  10
                )),
                (h.currentYear = parseInt(
                  h.months.eq(1).attr("data-year"),
                  10
                )))
              : ((h.currentMonth = parseInt(
                  h.months
                    .eq("next" === a ? h.months.length - 1 : 0)
                    .attr("data-month"),
                  10
                )),
                (h.currentYear = parseInt(
          ...
          (h.onMonthChangeStart = function (a) {
            ...
            h.months.eq(b).addClass("picker-calendar-month-current"),
              ...
              h.params.onMonthYearChangeStart &&
                h.params.onMonthYearChangeStart(
                  h,
                  h.currentYear,
                  h.currentMonth
            ...
            h.wrapper
              ...
              b
                ? (h.wrapper
                    ...
                    .remove(),
                  (d = h.monthHTML(
                    new Date(h.currentYear, h.currentMonth),
                    "prev"
                  )),
                  (c = h.monthHTML(
                    new Date(h.currentYear, h.currentMonth),
                ...
                : (e = h.monthHTML(new Date(h.currentYear, h.currentMonth), a)),
              ...
              h.params.onMonthAdd &&
                h.params.onMonthAdd(
                  h,
                  "next" === a
                    ? h.months.eq(h.months.length - 1)[0]
                    : h.months.eq(0)[0]
                ),
              h.params.onMonthYearChangeEnd &&
                h.params.onMonthYearChangeEnd(h, h.currentYear, h.currentMonth),
              h.updateSelectedInPickers();
          }),
          (h.updateSelectedInPickers = function () {
            var a = parseInt(
              ...
              e = parseInt(
                h.yearsPickerWrapper
                  .find(".picker-calendar-year-unit-selected")
                  .attr("data-year"),
                10
              ),
              f = parseInt(
                h.monthsPickerWrapper
                  .find(".picker-calendar-month-unit-selected")
                  .attr("data-month"),
                10
              );
            e !== a &&
              (h.yearsPickerWrapper
                ...
                .removeClass("picker-calendar-year-unit-selected"),
              h.yearsPickerWrapper
                .find('.picker-calendar-year-unit[data-year="' + a + '"]')
                .addClass("picker-calendar-year-unit-selected")),
              f !== c &&
                (h.monthsPickerWrapper
                  .find(".picker-calendar-month-unit")
                  .removeClass("picker-calendar-month-unit-selected"),
                h.monthsPickerWrapper
                  .find('.picker-calendar-month-unit[data-month="' + c + '"]')
                  .addClass("picker-calendar-month-unit-selected")),
              b !== a
                ? h.monthsPickerWrapper
                    .find(".picker-calendar-month-unit")
                    .removeClass("current-calendar-month-unit")
                : h.monthsPickerWrapper
                    .find('.picker-calendar-month-unit[data-month="' + d + '"]')
                    .addClass("current-calendar-month-unit");
          }),
          (h.setYearsTranslate = function (a) {
            (a = a || h.yearsTranslate || 0),
              "undefined" == typeof h.yearsTranslate && (h.yearsTranslate = a),
              h.yearsGroups.removeClass(
                "picker-calendar-years-current picker-calendar-years-prev picker-calendar-years-next"
              );
            var b = 100 * -(a + 1) * k,
              c = 100 * -a * k,
              d = 100 * -(a - 1) * k;
            h.yearsGroups
              ...
              .addClass("picker-calendar-years-prev"),
              h.yearsGroups
                .eq(1)
                .transform(
                  "translate3d(" +
                ...
                .addClass("picker-calendar-years-current"),
              h.yearsGroups
                .eq(2)
                .transform(
                  "translate3d(" +
          ...
          (h.nextYearsGroup = function (a) {
            ...
            h.yearsPickerWrapper
              ...
              b &&
                h.yearsPickerWrapper.transitionEnd(function () {
          ...
          (h.setMonthsTranslate = function (a) {
            (a = a || h.monthsTranslate || 0),
              "undefined" == typeof h.monthsTranslate &&
                (h.monthsTranslate = a),
              h.months.removeClass(
                "picker-calendar-month-current picker-calendar-month-prev picker-calendar-month-next"
              );
          ...
          (h.nextMonth = function (b) {
            ("undefined" != typeof b && "object" != typeof b) ||
              ((b = ""), h.params.animate || (b = 0));
            var c = parseInt(
                h.months.eq(h.months.length - 1).attr("data-month"),
                10
              ),
              d = parseInt(
                h.months.eq(h.months.length - 1).attr("data-year"),
                10
              ),
              e = new Date(d, c),
              f = e.getTime(),
            ...
            if ((h.monthsTranslate--, c === h.currentMonth)) {
              ...
              h.wrapper.append(j[0]),
                (h.months = h.wrapper.find(".picker-calendar-month")),
                h.params.onMonthAdd &&
                  h.params.onMonthAdd(h, h.months.eq(h.months.length - 1)[0]);
            }
          ...
          (h.prevMonth = function (b) {
            ...
            if ((h.monthsTranslate++, c === h.currentMonth)) {
              ...
              h.wrapper.prepend(j[0]),
                (h.months = h.wrapper.find(".picker-calendar-month")),
                h.params.onMonthAdd &&
                  h.params.onMonthAdd(h, h.months.eq(0)[0]);
            }
          ...
          (h.setYearMonth = function (a, b, c) {
            "undefined" == typeof a && (a = h.currentYear),
              ...
              ("undefined" != typeof c && "object" != typeof c) ||
                ((c = ""), h.params.animate || (c = 0));
            var d;
            if (
              ((d =
                a < h.currentYear
                  ? new Date(a, b + 1, -1).getTime()
          ...
          (h.layout = function () {
            var a,
              ...
              i =
                '<div class="picker-calendar-years-picker"><div class="picker-calendar-years-picker-wrapper">' +
                (e + f + g) +
                "</div></div>",
              j =
                '<div class="picker-calendar-months-picker"><div class="picker-calendar-months-picker-wrapper">' +
                h.monthsGroupHTML(d) +
                "</div></div>",
            ...
            if (h.params.weekHeader) {
              for (a = 0; 7 > a; a++) {
                var p =
                    a + h.params.firstDay > 6
                      ? a - 7 + h.params.firstDay
                      : a + h.params.firstDay,
                  q = h.params.dayNamesShort[p];
                o +=
                  '<div class="picker-calendar-week-day ' +
                  (h.params.weekendDays.indexOf(p) >= 0
            ...
            var r = h.params.toolbar
              ? h.params.toolbarTemplate.replace(
                  /{{closeText}}/g,
                  h.params.toolbarCloseText
                )
              : "";
            h.params.toolbar &&
              (r = h.params.toolbarTemplate
                .replace(/{{closeText}}/g, h.params.toolbarCloseText)
                .replace(
                  /{{monthPicker}}/g,
                  h.params.monthPicker ? h.params.monthPickerTemplate : ""
                )
                .replace(
                  /{{yearPicker}}/g,
                  h.params.yearPicker ? h.params.yearPickerTemplate : ""
                )),
              (b =
                '<div class="' +
                c +
          ...
          h.params.input &&
            ((h.input = a(h.params.input)),
            h.input.length > 0 &&
              (h.params.inputReadOnly && h.input.prop("readOnly", !0),
              h.inline || h.input.on("click", e),
              a(document).on("beforePageSwitch", function () {
          ...
          (h.open = function () {
            ...
            h.opened ||
              (h.value ||
                (h.params.value && ((h.value = h.params.value), (b = !0))),
              h.layout(),
              h.inline
                ? ((h.container = a(h.pickerHTML)),
                  h.container.addClass("picker-modal-inline"),
                  a(h.params.container).append(h.container))
                : ((h.container = a(a.pickerModal(h.pickerHTML))),
                  a(h.container).on("close", function () {
                    g();
                  })),
              (h.container[0].f7Calendar = h),
              (h.wrapper = h.container.find(".picker-calendar-months-wrapper")),
              (h.yearsPickerWrapper = h.container.find(
                ".picker-calendar-years-picker-wrapper"
              )),
              (h.yearsGroups = h.yearsPickerWrapper.find(
                ".picker-calendar-years-group"
              )),
              (h.monthsPickerWrapper = h.container.find(
    ...
    var b = function (b) {
      ...
      function d(b) {
        if (
          ...
          if (
            (a.closeModal(a(".picker-modal")), g.open(), g.params.scrollToInput)
          ) {
      ...
      function e(b) {
        g.opened &&
          (g.input && g.input.length > 0
            ? b.target !== g.input[0] &&
              0 === a(b.target).parents(".picker-modal").length &&
              g.close()
            : 0 === a(b.target).parents(".picker-modal").length && g.close());
      }
      function f() {
        (g.opened = !1),
          g.input &&
            g.input.length > 0 &&
            g.input.parents(".content").css({ "padding-bottom": "" }),
      ...
      var g = this,
        h = {
          ...
          toolbarCloseText: "确定",
          toolbarTemplate:
            '<header class="bar bar-nav">                <button class="button button-link pull-right close-picker">确定</button>                <h1 class="title">请选择</h1>                </header>',
        };
      b = b || {};
      ...
      return (
        (g.setValue = function (a, b) {
          for (var c = 0, d = 0; d < g.cols.length; d++)
            g.cols[d] &&
              !g.cols[d].divider &&
              (g.cols[d].setValue(a[c], b), c++);
        }),
        (g.updateValue = function () {
          for (var b = [], c = [], d = 0; d < g.cols.length; d++)
            g.cols[d].divider ||
              (b.push(g.cols[d].value), c.push(g.cols[d].displayValue));
          b.indexOf(void 0) >= 0 ||
            ((g.value = b),
            (g.displayValue = c),
            ...
            g.input &&
              g.input.length > 0 &&
              (a(g.input).val(
                g.params.formatValue
                  ? g.params.formatValue(g, g.value, g.displayValue)
                  : g.value.join(" ")
              ),
        ...
        (g.initPickerCol = function (b, c) {
          ...
          function e(b) {
            u ||
              ...
              (t = !0),
              (v = w =
                "touchstart" === b.type ? b.targetTouches[0].pageY : b.pageY),
              (x = new Date().getTime()),
              (F = !0),
          ...
          function f(b) {
            if (t) {
              b.preventDefault(),
                (F = !1),
                (w =
                  "touchmove" === b.type ? b.targetTouches[0].pageY : b.pageY),
                u ||
              ...
              (B = z + c),
                (A = void 0),
                q > B && ((B = q - Math.pow(q - B, 0.8)), (A = "min")),
                B > r && ((B = r + Math.pow(B - r, 0.8)), (A = "max")),
          ...
          function h(b) {
            ...
            (t = u = !1),
              ...
              A &&
                ("min" === A
                  ? m.wrapper.transform("translate3d(0," + q + "px,0)")
                  : m.wrapper.transform("translate3d(0," + r + "px,0)")),
              (y = new Date().getTime());
            var c, e;
            y - x > 300
              ? (e = B)
            ...
            g.params.freeMode || (e = -f * o + r),
              ...
              m.updateItems(f, e, "", !0),
              g.params.updateValuesOnMomentum &&
                (d(),
          ...
          if (!m.divider) {
            ...
            (m.replaceValues = function (a, b) {
              ...
              (m.calcSize = function () {
                g.params.rotateEffect &&
                  (m.container.removeClass("picker-items-col-absolute"),
                  m.width || m.container.css({ width: "" }));
                var b, c;
                (b = 0),
            ...
            (m.setValue = function (b, c, e) {
              ...
              var f = m.wrapper
                .find('.picker-item[data-picker-value="' + b + '"]')
                .index();
              ...
              (m.updateItems = function (b, c, d, e) {
                "undefined" == typeof c &&
                  (c = a.getTranslate(m.wrapper[0], "y")),
                ...
                if (
                  ((e || "undefined" == typeof e) &&
                    ((m.value = h.attr("data-picker-value")),
                    (m.displayValue = m.displayValues
                      ? m.displayValues[b]
                      : m.value),
                    f !== b &&
                      (m.onChange && m.onChange(g, m.value, m.displayValue),
                      g.updateValue())),
                  g.params.rotateEffect)
                ) {
                  ...
                  m.items.each(function () {
                    ...
                    i > 180 && (i = 180),
                      -180 > i && (i = -180),
                      Math.abs(g) > h
                        ? b.addClass("picker-item-far")
                        : b.removeClass("picker-item-far"),
                      b.transform(
                        "translate3d(0, " +
                          (-c + r) +
                          "px, " +
        ...
        (g.columnHTML = function (a, b) {
          ...
          if (a.divider)
            d +=
              ...
              (a.textAlign ? "picker-items-col-" + a.textAlign : "") +
              " " +
              (a.cssClass || "") +
              '">' +
              a.content +
            ...
            for (var e = 0; e < a.values.length; e++)
              c +=
                ...
                a.values[e] +
                '">' +
                (a.displayValues ? a.displayValues[e] : a.values[e]) +
                "</div>";
            d +=
        ...
        (g.layout = function () {
          ...
          (c =
            ...
            (g.params.cssClass || "") +
            (g.params.rotateEffect ? " picker-3d" : "")),
            (b =
              '<div class="' +
              c +
              '">' +
              (g.params.toolbar
                ? g.params.toolbarTemplate.replace(
                    /{{closeText}}/g,
                    g.params.toolbarCloseText
                  )
                : "") +
        ...
        g.params.input &&
          ((g.input = a(g.params.input)),
          g.input.length > 0 &&
            (g.params.inputReadOnly && g.input.prop("readOnly", !0),
        ...
        (g.open = function () {
          g.opened ||
            ...
            g.container.find(".picker-items-col").each(function () {
              var a = !0;
              ((!g.initialized && g.params.value) ||
                (g.initialized && g.value)) &&
                (a = !1),
                g.initPickerCol(this, a);
            }),
            g.initialized
              ? g.value && g.setValue(g.value, 0)
              : g.params.value && g.setValue(g.params.value, 0)),
            (g.initialized = !0),
      ...
      (a.fn.picker = function (c) {
        ...
        return this.each(function () {
          if (this) {
            ...
            if (!f) {
              var g = a.extend(
                { input: this, value: e.val() ? e.val().split(" ") : "" },
                c
              );
  ...
  +(function (a) {
    ...
    function c(a, b, c) {
      ...
      return (
        ...
        "h" === a
          ? (c === !0 &&
              ((d.style.cssText += ";height:5px;left:2px;right:2px;bottom:0"),
              (e.style.height = "100%")),
            (d.className = "iScrollHorizontalScrollbar"))
          : (c === !0 &&
              ((d.style.cssText += ";width:5px;bottom:2px;top:2px;right:1px"),
              (e.style.width = "100%")),
    ...
    function d(b, c) {
      (this.wrapper =
        "string" == typeof c.el ? document.querySelector(c.el) : c.el),
      ...
      (this.sizeRatioX = 1),
        ...
        this.options.fade &&
          ...
          (this.wrapperStyle[f.style.transitionDuration] = f.isBadAndroid
            ? "0.001s"
            : "0ms"),
      ...
      f = (function () {
        ...
        (c.getTime =
          ...
          (c.prefixPointerEvent = function (b) {
            return a.MSPointerEvent
              ? "MSPointer" + b.charAt(9).toUpperCase() + b.substr(10)
              : b;
          }),
          (c.momentum = function (a, b, c, d, f, g, h) {
            function i() {
              +new Date() - o > 50 &&
                (h._execEvent("scroll"), (o = +new Date())),
                +new Date() - n < k && e(i);
            }
            var j,
              k,
        ...
        return (
          ...
          (c.click = function (a) {
            var b,
              c = a.target;
            /(SELECT|INPUT|TEXTAREA)/i.test(c.tagName) ||
    ...
    (b.prototype = {
      ...
      _start: function (a) {
        if (
          (1 === f.eventType[a.type] || 0 === a.button) &&
          this.enabled &&
          (!this.initiated || f.eventType[a.type] === this.initiated)
        ) {
          !this.options.preventDefault ||
            f.isBadAndroid ||
          ...
          if (
            ...
            if (
              (this.directionLocked ||
                this.options.freeScroll ||
                (d > e + this.options.directionLockThreshold
                  ? (this.directionLocked = "h")
                  : e >= d + this.options.directionLockThreshold
        ...
        if (this.enabled && f.eventType[a.type] === this.initiated) {
          ...
          if (
            ...
            if ((this.scrollTo(e, g), !this.moved))
              return (
                this.options.tap && f.tap(a, this.options.tap),
            ...
            if (
              ...
              (this.currentPage = l),
                (j =
                  ...
                  Math.max(
                    Math.max(
                      Math.min(Math.abs(e - l.x), 1e3),
                      Math.min(Math.abs(g - l.y), 1e3)
                    ),
                    300
                  )),
                (e = l.x),
      ...
      resetPosition: function (b) {
        ...
        if (
          ...
          !this.hasHorizontalScroll || this.x > 0
            ? (c = 0)
            : this.x < this.maxScrollX && (c = this.maxScrollX),
          !this.hasVerticalScroll || this.y > 0
            ? (d = 0)
            : this.y < this.maxScrollY && (d = this.maxScrollY),
          c === this.x && d === this.y)
        )
          return !1;
        if (
      ...
      scrollToElement: function (a, b, c, d, e) {
        if ((a = a.nodeType ? a : this.scroller.querySelector(a))) {
          ...
          (g.left -= this.wrapperOffset.left),
            ...
            d === !0 &&
              (d = Math.round(
                a.offsetHeight / 2 - this.wrapper.offsetHeight / 2
              )),
            (g.left -= c || 0),
            (g.top -= d || 0),
            (g.left =
            ...
            (b =
              void 0 === b || null === b || "auto" === b
                ? Math.max(Math.abs(this.x - g.left), Math.abs(this.y - g.top))
                : b),
        ...
        if (
          (this.options.useTransform
            ? (this.scrollerStyle[f.style.transform] =
                "translate(" + a + "px," + b + "px)" + this.translateZ)
            : ((a = Math.round(a)),
              (b = Math.round(b)),
      ...
      _initEvents: function (b) {
        ...
        c(a, "orientationchange", this),
          ...
          f.hasPointer &&
            !this.options.disablePointer &&
            (c(this.wrapper, f.prefixPointerEvent("pointerdown"), this),
      ...
      getComputedPosition: function () {
        ...
        return (
          this.options.useTransform
            ? ((d = d[f.style.transform].split(")")[0].split(", ")),
              (b = +(d[12] || d[4])),
              (c = +(d[13] || d[5])))
          ...
          if (
            ...
            1 === a.deltaMode
              ? ((b = -a.deltaX * this.options.mouseWheelSpeed),
                (c = -a.deltaY * this.options.mouseWheelSpeed))
          ...
          this.on("refresh", function () {
            ...
            if (
              ...
              if (this.options.snap === !0)
                for (
                  c = Math.round(j / 2), d = Math.round(k / 2);
                  i > -this.scrollerWidth;

                ) {
                  for (
                    this.pages[g] = [], a = 0, e = 0;
                    e > -this.scrollerHeight;
                ...
                for (f = this.options.snap, a = f.length, b = -1; a > g; g++)
                  (0 === g || f[g].offsetLeft <= f[g - 1].offsetLeft) &&
                    ((h = 0), b++),
      ...
      _nearestSnap: function (a, b) {
        ...
        if (
          ...
          Math.abs(b - this.absStartY) < this.snapThresholdY
        )
        ...
        return (
          c === this.currentPage.pageX &&
            ...
            0 > c
              ? (c = 0)
              : c >= this.pages.length && (c = this.pages.length - 1),
            (a = this.pages[c][0].x)),
          e === this.currentPage.pageY &&
            ((e += this.directionY),
            0 > e
              ? (e = 0)
              : e >= this.pages[0].length && (e = this.pages[0].length - 1),
            (b = this.pages[0][e].y)),
          { x: a, y: b, pageX: c, pageY: e }
        );
      },
        ...
        (c =
          void 0 === c
            ? this.options.snapSpeed ||
              Math.max(
                Math.max(
                  Math.min(Math.abs(e - this.x), 1e3),
                  Math.min(Math.abs(f - this.y), 1e3)
                ),
                300
              )
            : c),
          (this.currentPage = { x: e, y: f, pageX: a, pageY: b }),
      ...
      _initKeys: function () {
        ...
        if ("object" == typeof this.options.keyBindings)
          for (b in this.options.keyBindings)
            "string" == typeof this.options.keyBindings[b] &&
              (this.options.keyBindings[b] = this.options.keyBindings[b]
                .toUpperCase()
                .charCodeAt(0));
        ...
        if (this.enabled) {
          ...
          switch (
            ...
            (this.keyAcceleration =
              200 > g - h ? Math.min(this.keyAcceleration + i, 50) : 0),
            a.keyCode)
          ) {
            case this.options.keyBindings.pageUp:
              this.hasHorizontalScroll && !this.hasVerticalScroll
                ? (d += c ? 1 : this.wrapperWidth)
                : (e += c ? 1 : this.wrapperHeight);
              break;
          ...
          d > 0
            ? ((d = 0), (this.keyAcceleration = 0))
            : d < this.maxScrollX &&
              ((d = this.maxScrollX), (this.keyAcceleration = 0)),
            e > 0
              ? ((e = 0), (this.keyAcceleration = 0))
              : e < this.maxScrollY &&
                ((e = this.maxScrollY), (this.keyAcceleration = 0)),
            this.scrollTo(d, e, 0),
            (this.keyTime = g);
        }
      },
      ...
      (d.prototype = {
        ...
        _start: function (b) {
          ...
          b.preventDefault(),
            ...
            this.options.disablePointer ||
              f.addEvent(a, f.prefixPointerEvent("pointermove"), this),
        ...
        _move: function (a) {
          ...
          this.moved || this.scroller._execEvent("scrollStart"),
            ...
            (e = this.y + c),
            this._pos(d, e),
            1 === this.scroller.options.probeType && h - this.startTime > 300
              ? ((this.startTime = h), this.scroller._execEvent("scroll"))
        ...
        _end: function (b) {
          if (this.initiated) {
            if (
              ...
              var c = this.scroller._nearestSnap(
                  this.scroller.x,
                  this.scroller.y
                ),
                d =
        ...
        transitionTime: function (a) {
          (a = a || 0),
            ...
            !a &&
              f.isBadAndroid &&
              (this.indicatorStyle[f.style.transitionDuration] = "0.001s");
        },
        ...
        _pos: function (a, b) {
          0 > a ? (a = 0) : a > this.maxPosX && (a = this.maxPosX),
            ...
            (a = this.options.listenX
              ? Math.round(a / this.sizeRatioX)
              : this.scroller.x),
            (b = this.options.listenY
              ? Math.round(b / this.sizeRatioY)
              : this.scroller.y),
      ...
      return (
        this.each(function () {
          var f = a(this),
            ...
            h = f.data("scroller");
          return (
            h || f.data("scroller", (h = new d(this, g))),
            "string" == typeof b &&
            "function" == typeof h[b] &&
            ((e = h[b].apply(h, c)), void 0 !== e)
              ? !1
              : void 0
          );
        }),
      ...
      a.extend(a.fn, {
        scrollTop: function (a, b) {
          if (this.length) {
            ...
            return d && d.scroller
              ? d.scrollTop(a, b)
              : c.scrollTop.apply(this, arguments);
          }
        },
      }),
        a.extend(a.fn, {
          scrollLeft: function (a, b) {
            if (this.length) {
              ...
              return d && d.scroller
                ? d.scrollLeft(a, b)
                : c.scrollLeft.apply(this, arguments);
            }
          },
        });
    })();
    var d = function (b, c) {
      ...
      var e = this.options.type,
        f =
          ...
          ("auto" === e &&
            a.device.android &&
            a.compareVersion("4.4.0", a.device.osVersion) > -1) ||
          ("auto" === e &&
            a.device.ios &&
            a.compareVersion("6.0.0", a.device.osVersion) > -1);
      if (f) {
        var g = d.find(".content-inner");
        if (!g[0]) {
          var h = d.children();
          h.length < 1
            ? d.children().wrapAll('<div class="content-inner"></div>')
            : d.html('<div class="content-inner">' + d.html() + "</div>");
        }
        ...
        j && ((l.ptr = !0), (l.ptrOffset = 44)),
          ...
          (a.pullToRefreshTrigger =
            a._pullToRefreshJSScroll.pullToRefreshTrigger),
    ...
    d.prototype = {
      ...
      scrollTop: function (a, b) {
        return this.scroller
          ? void 0 === a
            ? -1 * this.scroller.getComputedPosition().y
            : (this.scroller.scrollTo(0, -1 * a, b), this)
          : this.$pageContent.scrollTop(a, b);
      },
      scrollLeft: function (a, b) {
        return this.scroller
          ? void 0 === a
            ? -1 * this.scroller.getComputedPosition().x
            : (this.scroller.scrollTo(-1 * a, 0), this)
          : this.$pageContent.scrollTop(a, b);
      },
      on: function (a, b) {
        return (
          this.scroller
            ? this.scroller.on(a, function () {
                b.call(this.wrapper);
              })
      ...
      off: function (a, b) {
        return (
          this.scroller ? this.scroller.off(a, b) : this.$pageContent.off(a, b),
          this
        );
      },
      refresh: function () {
      ...
      scrollHeight: function () {
        return this.scroller
          ? this.scroller.scrollerHeight
          : this.$pageContent[0].scrollHeight;
      },
    };
    var e = a.fn.scroller;
    (a.fn.scroller = b),
      ...
      (a.refreshScroller = function (b) {
        b
          ? a(b).scroller("refresh")
          : a(".javascript-scroll").each(function () {
      ...
      (a.getScroller = function (b) {
        return (
          (b = b.hasClass("content") ? b : b.parents(".content")),
          b
            ? a(b).data("scroller")
            : a(".content.javascript-scroll").data("scroller")
        );
      }),
      (a.detectScrollerType = function (b) {
        return b
          ? a(b).data("scroller") && a(b).data("scroller").scroller
            ? "js"
            : "native"
          : void 0;
      });
  ...
  +(function (a) {
    ...
    var b = function (b, c, d) {
        var e = a(b);
        if (
          (2 === arguments.length && "boolean" == typeof c && (d = c),
          0 === e.length)
        )
          return !1;
        ...
        if (
          ...
          return (
            c && c.length > 0 && c.addClass("active"),
  ...
  +(function (a) {
    ...
    (c.prototype = {
      ...
      _bindEvents: function () {
        this.$pageContent
          .parents(".content")
          .on("scroll", this._scrollHandler.bind(this)),
          this.$pageContent.on(
            "active",
            ".tab-link",
            this._tabLinkHandler.bind(this)
          );
      },
      ...
      _scrollHandler: function (b) {
        var c = a(b.target),
          ...
          i = h >= g - f;
        i
          ? (e.insertAfter(d), d.addClass("buttons-fixed").css("top", f))
          : (e.remove(), d.removeClass("buttons-fixed").css("top", 0));
      },
    }),
      (a.fn.fixedTab = b),
  ...
  +(function (a) {
    ...
    var b = 0,
      c = function (c) {
        function d() {
          j.hasClass("refreshing") ||
            (-1 * i.scrollTop() >= 44
              ? j.removeClass("pull-down").addClass("pull-up")
              : j.removeClass("pull-up").addClass("pull-down"));
        }
        function e() {
          j.hasClass("refreshing") ||
            (j.removeClass("pull-down pull-up"),
        ...
        var g = a(c);
        if (
          (g.hasClass("pull-to-refresh-content") ||
            (g = g.find(".pull-to-refresh-content")),
          g && 0 !== g.length)
        ) {
      ...
      f = function (b) {
        b = a(b);
        var c = b.hasClass("pull-to-refresh-content")
          ? b
          : b.find(".pull-to-refresh-content");
        0 !== c.length &&
          c[0].destroyPullToRefresh &&
          c[0].destroyPullToRefresh();
      };
    ...
    (a.initPullToRefresh = function (b) {
      ...
      function d(b) {
        if (h) {
          ...
          if (
            ("undefined" == typeof j &&
              (j = !!(j || Math.abs(d - s.y) > Math.abs(c - s.x))),
            !j)
          )
            return void (h = !1);
          if (
            ...
            if ((m.removeClass("transitioning"), o > m[0].offsetHeight))
              return void (h = !1);
            r &&
              ((q = m.attr("data-ptr-distance")),
              q.indexOf("%") >= 0 &&
                (q = (m[0].offsetHeight * parseInt(q, 10)) / 100)),
              (v = m.hasClass("refreshing") ? q : 0),
              (u = m[0].scrollHeight === m[0].offsetHeight || !a.device.ios),
              (u = !0);
          }
          return (
            (i = !0),
            ...
            (k > 0 && 0 >= o) || 0 > o
              ? (a.device.ios &&
                  parseInt(a.device.osVersion.split(".")[0], 10) > 7 &&
                  0 === o &&
                  !p &&
                  (u = !0),
                u &&
                ...
                (u && Math.pow(k, 0.85) > q) || (!u && k >= 2 * q)
                  ? ((t = !0), m.addClass("pull-up").removeClass("pull-down"))
                  : ((t = !1), m.removeClass("pull-up").addClass("pull-down")),
                void 0)
              : (m.removeClass("pull-up pull-down"), void (t = !1))
          );
        }
      }
      function e() {
      ...
      (a.pullToRefreshTrigger = function (b) {
        (b = a(b)),
          0 === b.length && (b = a(".pull-to-refresh-content")),
          b.hasClass("refreshing") ||
            (b.addClass("transitioning refreshing"), b.trigger("refresh"));
      }),
      ...
      (a.initSwipePanels = function () {
        function b(b) {
          if (
            ...
            (g || h) &&
            !m &&
            !(a(".modal-in, .photo-browser-in").length > 0) &&
            (i || h || !(a(".panel.active").length > 0) || e.hasClass("active"))
          ) {
            if (
              ((x.x =
                "touchstart" === b.type ? b.targetTouches[0].pageX : b.pageX),
              (x.y =
                "touchstart" === b.type ? b.targetTouches[0].pageY : b.pageY),
              i || h)
            ) {
              if (a(".panel.active").length > 0)
                f = a(".panel.active").hasClass("panel-left")
                  ? "left"
                  : "right";
              else {
                if (h) return;
        ...
        function c(b) {
          if (m && e[0] && !b.f7PreventPanelSwipe) {
            ...
            if (
              ("undefined" == typeof o &&
                (o = !!(o || Math.abs(d - x.y) > Math.abs(c - x.x))),
              o)
            )
              return void (m = !1);
            if (
              !v &&
              ((v = c > x.x ? "to-right" : "to-left"),
              ("left" === f && "to-left" === v && !e.hasClass("active")) ||
                ("right" === f && "to-right" === v && !e.hasClass("active")))
            )
              return void (m = !1);
            if (l) {
              ...
              return (
                300 > g &&
                  ("to-left" === v &&
                    ("right" === f && a.openPanel(f),
                    "left" === f && e.hasClass("active") && a.closePanel()),
                  "to-right" === v &&
                    ("left" === f && a.openPanel(f),
            ...
            n ||
              ((u = e.hasClass("panel-cover") ? "cover" : "reveal"),
              s || (e.show(), w.show()),
              (t = e[0].offsetWidth),
              e.transition(0)),
              (n = !0),
            ...
            "right" === f && (h = -h),
              (q = c - x.x + h),
              "right" === f
                ? ((r = q - (s ? t : 0)), r > 0 && (r = 0), -t > r && (r = -t))
                : ((r = q + (s ? t : 0)), 0 > r && (r = 0), r > t && (r = t)),
              "reveal" === u
                ? (y.transform("translate3d(" + r + "px,0,0)").transition(0),
                  w.transform("translate3d(" + r + "px,0,0)"))
                : e.transform("translate3d(" + r + "px,0,0)").transition(0);
          }
        }
        function d(b) {
          ...
          if (
            ...
            if (s) (a.allowPanelOpen = !0), a.openPanel(f);
              ...
              (a.allowPanelOpen = !0), e.css({ display: "" });
            else {
              var h = "reveal" === u ? y : e;
  ...
  +(function (a) {
    ...
    function b(a) {
      ...
      var d = a.get(0),
        ...
        f = ["http", "https"];
      return /^(\w+):/.test(e) && f.indexOf(RegExp.$1) < 0
        ? !0
        : !!d.hasAttribute("external");
    }
    function c(b) {
    ...
    var d = {
      ...
      e = {
        ...
        supportStorage: function () {
          ...
          try {
            return (
              sessionStorage.setItem(a, a), sessionStorage.removeItem(a), !0
            );
          } catch (b) {
            return !1;
          }
    ...
    (i.prototype._init = function () {
      ...
      var d,
        ...
        l = k.eq(0);
      if (
        (i.fragment && (g = b.find("#" + i.fragment)),
        g && g.length ? (k = g.eq(0)) : k.length || (k = j.eq(0)),
        k.attr("id") || k.attr("id", this._generateRandomId()),
        l.length && l.attr("id") !== k.attr("id")
          ? (l.removeClass(f.curPageClass), k.addClass(f.curPageClass))
          : k.addClass(f.curPageClass),
        (d = k.attr("id")),
        null === h.state)
      ) {
        var m = {
      ...
      (i.prototype.load = function (b, c) {
        void 0 === c && (c = !1),
          this._isTheSameDocument(location.href, b)
            ? this._switchToSection(e.getUrlFragment(b))
            : (this._saveDocumentIntoCache(a(document), location.href),
      ...
      (i.prototype._switchToSection = function (b) {
        if (b) {
          var c = this._getCurrentSection(),
            d = a("#" + b);
          c !== d &&
            (this._animateSection(c, d, g.rightToLeft),
      ...
      (i.prototype._switchToDocument = function (a, b, c, d) {
        ...
        var g = this.cache[f],
          h = this;
        g
          ? this._doSwitchDocument(a, c, d)
          : this._loadDocument(a, {
              success: function (b) {
                try {
      ...
      (i.prototype._saveAsCurrentState = function (a) {
        sessionStorage.setItem(
          this.sessionNames.currentState,
          JSON.stringify(a)
        );
      }),
      ...
      (i.prototype._incMaxStateId = function () {
        sessionStorage.setItem(
          this.sessionNames.maxStateId,
          this._getNextStateId()
        );
      }),
      ...
      (i.prototype._onPopState = function (a) {
        ...
        if (b && b.pageId) {
          ...
          return c
            ? void (
                b.id !== c.id &&
                (b.id < c.id ? this._back(b, c) : this._forward(b, c))
              )
            : void (
                console.error &&
                console.error("Missing last state when backward or forward")
              );
        }
      }),
  ...
  +(function (a) {
    ...
    a.lastPosition = function (b) {
      ...
      if (sessionStorage) {
        ...
        a(window)
          .off("beforePageSwitch")
          .on("beforePageSwitch", function (a, b, c) {
            d(b, c);
          }),
          a(window)
            .off("pageAnimationStart")
            .on("pageAnimationStart", function (a, b, d) {
              c(b, d);
            });
      }
    };
  ...
  +(function (a) {
    ...
    (a.initPage = function (c) {
      ...
      a.smConfig.showPageLoadingIndicator &&
        (a(window).on("pageLoadStart", function () {
          a.showIndicator();
        }),
