...
(function (e, t) {
  ...
  return (
    ...
    (n.fn = n.prototype =
      {
        ...
        removeClass: function (e) {
          ...
          return (
            e
              ? this.hasClass(e) && (t.className = t.className.replace(e, " "))
              : (t.className = ""),
            this
          );
        },
        css: function (e, r) {
          ...
          if (typeof e == "string") {
            ...
            for (i in o)
              i === "opacity" ? n.opacity.set(s, o[i]) : (s.style[i] = o[i]);
          return this;
        },
        show: function () {
    ...
    (n.fn.init = function (e, t) {
      ...
      if (e === "head" || e === "html")
        return (this[0] = t.getElementsByTagName(e)[0]), this;
      if (typeof e == "string") {
        r = u.exec(e);
        if (r && r[2])
          return (
    ...
    (n.removeData = function (e, t) {
      ...
      if (t) {
        ...
        delete s[o], e.removeAttribute ? e.removeAttribute(i) : (e[i] = null);
    }),
    (n.uuid = 0),
    (n.cache = {}),
    ...
    (n.event = {
      add: function (e, t, r) {
        ...
        (i = u[t] = u[t] || {}),
          ...
          i.handler ||
            ...
            e.addEventListener
              ? e.addEventListener(t, i.handler, !1)
              : e.attachEvent("on" + t, i.handler));
      },
      remove: function (e, t, r) {
        ...
        if (s.listeners.length === 0) {
          e.removeEventListener
            ? e.removeEventListener(t, s.handler, !1)
            : e.detachEvent("on" + t, s.handler),
            delete f[t],
            (s = n.data(e, "@events"));
          for (var l in s) a = !1;
      ...
      handler: function (t) {
        return function (r) {
          ...
          for (var i = 0, s = t.listeners, o; (o = s[i++]); )
            o.call(t.elem, r) === !1 &&
      ...
      : document.attachEvent &&
        (s = function () {
          document.readyState === "complete" &&
            (document.detachEvent("onreadystatechange", s), n.ready());
        }),
    (n.css =
    ...
    (n.opacity = {
      get: function (e) {
        return o
          ? document.defaultView.getComputedStyle(e, !1).opacity
          : l.test(
    ...
    n.each(["Left", "Top"], function (e, t) {
      ...
      n.fn[r] = function () {
        ...
        return (
          ...
          n
            ? "pageXOffset" in n
              ? n[e ? "pageYOffset" : "pageXOffset"]
              : n.document.documentElement[r] || n.document.body[r]
            : t[r]
        );
      };
    }),
    n.each(["Height", "Width"], function (e, t) {
      ...
      n.fn[r] = function (e) {
        ...
        return r
          ? n.isWindow(r)
            ? r.document.documentElement["client" + t] ||
              r.document.body["client" + t]
            : r.nodeType === 9
            ? Math.max(
                r.documentElement["client" + t],
                r.body["scroll" + t],
                r.documentElement["scroll" + t],
                r.body["offset" + t],
                r.documentElement["offset" + t]
              )
            : null
          : e == null
          ? null
    ...
    (n.ajax = function (t) {
      ...
      (r.onreadystatechange = function () {
        r.readyState === 4 &&
          r.status === 200 &&
          (t.success && t.success(r.responseText),
          (r.onreadystatechange = n.noop));
      }),
        r.open("GET", i, 1),
        r.send(null);
    }),
      ...
      return (
        ...
        n.each(e, function (e, t) {
          (u = new n.fx(s, p, e)),
            (a = c.exec(t)),
            (f = parseFloat(
              e === "opacity" || (s.style && s.style[e] != null)
                ? n.css(s, e)
                : s[e]
            )),
            (l = parseFloat(a[2])),
    ...
    (n.fx.prototype = {
      ...
      step: function () {
        ...
        if (t >= e.options.speed + e.startTime) {
          ...
          for (var i in e.options.curAnim)
            e.options.curAnim[i] !== !0 && (r = !1);
          return r && e.options.callback.call(e.elem), !1;
        }
        var s = t - e.startTime;
        return (
          (e.state = s / e.options.speed),
          (e.pos = n.easing[e.options.easing](
            e.state,
            s,
            0,
            1,
  ...
  (function (e, t, n) {
    ...
    var r,
      ...
      p =
        ("createTouch" in document && !("onmousemove" in c)) ||
        ...
        return (
          ...
          f && o
            ...
            : (p && (t.fixed = !1),
              ...
              s !== n && (t.cancel = s),
              t.ok &&
                t.button.push({ name: t.okVal, callback: t.ok, focus: !0 }),
              t.cancel &&
                t.button.push({ name: t.cancelVal, callback: t.cancel }),
    ...
    (v.fn = v.prototype =
      {
        ...
        _init: function (e) {
          ...
          return (
            ...
            i.iconBg.css(o || { background: "none" }),
        ...
        title: function (e) {
          ...
          return e === n
            ? i[0]
            : (e === !1
                ? (i.hide().html(""), r.addClass(s))
                : (i.show().html(e || ""), r.removeClass(s)),
              this);
        },
        position: function (e, t) {
          ...
          if (e || e === 0)
            (r._left = e.toString().indexOf("%") !== -1 ? e : null),
              (e = r._toNumber(e, v - g)),
              typeof e == "number"
                ? ((e = u ? (e += l) : e + p), (b.left = Math.max(e, p) + "px"))
                : typeof e == "string" && (b.left = e);
          if (t || t === 0)
            (r._top = t.toString().indexOf("%") !== -1 ? t : null),
              (t = r._toNumber(t, m - y)),
              typeof t == "number"
                ? ((t = u ? (t += c) : t + d), (b.top = Math.max(t, d) + "px"))
                : typeof t == "string" && (b.top = t);
          return (
            e !== n && t !== n && ((r._follow = null), r._autoPositionType()), r
          );
        },
        size: function (e, t) {
          var n,
          ...
          return (
            e &&
              ((o._width = e.toString().indexOf("%") !== -1 ? e : null),
              ...
              typeof e == "number"
                ? ((h.width = "auto"),
                  ...
                  (h.width = l[0].offsetWidth + "px"))
                : typeof e == "string" &&
                  ((p.width = e), e === "auto" && l.css("width", "auto"))),
            t &&
              ((o._height = t.toString().indexOf("%") !== -1 ? t : null),
              (r = a.height() - l[0].offsetHeight + c[0].offsetHeight),
              (s = o._toNumber(t, r)),
              (t = s),
              typeof t == "number"
                ? (p.height = Math.max(o.config.minHeight, t) + "px")
                : typeof t == "string" && (p.height = t)),
            o._ie6SelectFix(),
            o
          );
        },
          ...
          return r[0] === n
            ...
            : (e.each(f, function (n, r) {
                ...
                a[i] || (a[i] = {}),
                  ...
                  r.focus &&
                    (t._focus && t._focus.removeClass(u),
        ...
        lock: function () {
          ...
          var t = this,
            ...
            a =
              t._lockMask || e(u[0].appendChild(document.createElement("div"))),
          ...
          return (
            ...
            i.duration === 0
              ? a.css({ opacity: i.opacity })
              : a.animate({ opacity: i.opacity }, i.duration),
            (t._lockMaskWrap = u),
            (t._lockMask = a),
            (t._lock = !0),
            t
        ...
        unlock: function () {
          ...
          return (
            ...
            e.config.duration
              ? n.animate({ opacity: 0 }, e.config.duration, s)
              : s(),
            (e._lock = !1),
            e
          );
        ...
        _getDOM: function () {
          ...
          var r,
            ...
            u = o.length;
          for (; i < u; i++)
            (r = o[i].className.split("aui_")[1]), r && (s[r] = e(o[i]));
          return s;
        },
        ...
        _ie6SelectFix: h
          ? function () {
              ...
              (i += "px"),
                (s += "px"),
                r
                  ? ((r.style.width = i), (r.style.height = s))
                  : ((r = t.appendChild(document.createElement("iframe"))),
                    (e[n] = r),
                    (r.src = "about:blank"),
                    (r.style.cssText =
                      "position:absolute;z-index:-1;left:0;top:0;filter:alpha(opacity=0);width:" +
                      i +
                      ";height:" +
                      s));
            }
        ...
        _runScript: function (e) {
          var t,
            ...
            o = [];
          for (; n < s; n++)
            i[n].type === "text/dialog" && ((o[r] = i[n].innerHTML), r++);
            ...
            function () {
              ...
              if (h) {
                ...
                this._setAbsolute(),
                  t.setExpression(
                    "left",
                    "eval(" + o + ".scrollLeft + " + (n - i) + ') + "px"'
                  ),
                  t.setExpression(
                    "top",
                    "eval(" + o + ".scrollTop + " + (r - s) + ') + "px"'
                  );
  ...
  (function (e) {
    ...
    (artDialog.dragEvent = function () {
      ...
      (artDialog.dragEvent.prototype = {
        ...
        start: function (e) {
          return (
            i.bind("mousemove", this.move).bind("mouseup", this.end),
        ...
        onend: e.noop,
          ...
          return (
            i.unbind("mousemove", this.move).unbind("mouseup", this.end),
      ...
      (n = function (e) {
        ...
        (t.onstart = function (e, n) {
          h
            ? ((s = g[0].offsetWidth), (f = g[0].offsetHeight))
            : ((l = v[0].offsetLeft), (c = v[0].offsetTop)),
      ...
      i.bind("mousedown", function (e) {
        ...
        var i = e.target,
          ...
          o = r.DOM;
        if (
          (s.drag !== !1 && i === o.title[0]) ||
          (s.resize !== !1 && i === o.se[0])
        )
          return (t = t || new artDialog.dragEvent()), n(e), !1;
      });
