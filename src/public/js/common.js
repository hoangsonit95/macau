    ...
    function (data) {
      if (data.sign == true) {
        art.dialog({
          ...
          title: "平台公告",
          content:
            '<div style="border-bottom:1px solid #ddd;height:40px; line-height:40px;"><p style="float:left; font-size:16px;">' +
            data.data.title +
  ...
  $.post(
    ...
    function (data) {
      if (data.sign == true) {
        ...
        var html = "";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">彩种:</div><div class="pull-left">' +
          data.BillInfo.cptitle +
          "</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">期号:</div><div class="pull-left" way-data="showExpect.currFullExpect">' +
          data.BillInfo.expect +
          "</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">玩法:</div><div style=" text-align: left;white-space:normal;word-break:break-all;">' +
          data.BillInfo.playtitle +
          "(赔率:" +
          data.BillInfo.mode +
          ")</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">内容:</div><div class="textarea" style="text-align: left;white-space:normal;word-break:break-all;word-wrap:break-word:;">' +
          data.BillInfo.tzcode +
          "</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">金额:</div><div style="text-align: left;white-space:normal;word-break:break-all;">' +
          data.BillInfo.amount +
          "(注数:" +
          data.BillInfo.itemcount +
          ")</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">开奖:</div><div style="text-align: left;white-space:normal;word-break:break-all;">' +
          data.BillInfo.opencode +
          "</div></div>";
        html +=
          '<div class="clearfix"><div class="pull-left" style="width:50px;">状态:</div><div style="text-align: left;white-space:normal;word-break:break-all;">' +
          data.BillInfo.state +
          "</div></div>";
