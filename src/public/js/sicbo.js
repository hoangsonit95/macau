...
var limit = 10;
var page = 1;
socket.on('data-server-sicbo', function (msg) {
  // if (msg.data[0].game != "sicbo") return;
  $('.Loading').fadeIn(0);
  setTimeout(() => {
    let data1 = msg.data[0]; // lấy ra cầu mới nhất
    let myFunc = num => Number(num);

    var intArr = Array.from(String(data1.ketqua), myFunc);
    let ketqua = intArr;
    let data2 = []; // lấy ra cầu cũ
    let data3 = data2.push(msg.data[1]);
    $('.time-box .info .number').text(data1.period);
    $('.time-sicbo .session-next .number-sicbo__next .number').text(
      data1.period + 1,
    );
    $('.number-sicbo .result-sicbo img:eq(0)').attr(
      'src',
      `/images/xucsac${ketqua[0]}.png`,
    );
    $('.number-sicbo .result-sicbo img:eq(1)').attr(
      'src',
      `/images/xucsac${ketqua[1]}.png`,
    );
    $('.number-sicbo .result-sicbo img:eq(2)').attr(
      'src',
      `/images/xucsac${ketqua[2]}.png`,
    );
    ...
    $.ajax({
      type: 'POST',
      url: '/api/webapi/sicbo/GetNoaverageEmerdList',
      data: {
        typeid: '1',
        pageno: '0',
        pageto: '10',
...
$('.number-box .button').click(function (e) {
  ...
  let addText = $(this).text().trim().split(' ')[0]; // xanh - do - tim
  //   console.log(addText);
  alertBox(addTop, addText);
});
...
$('.foot .right').click(function (e) {
  ...
  $.ajax({
    type: 'POST',
    url: '/api/webapi/action/sicbo/join',
    data: {
      typeid: '1',
      join: join,
      x: x,
  ...
  if (x == 1) {
    ...
    let result = list_orders.map(list_orders => {
      let resultData = [
        ...
        '<div data-v-34b49f94="" class="li" id="SM"><div data-v-34b49f94="">S</div></div>',
      ];
      let key = Number(list_orders.amount);
      resultData[
        key
      ] = `<div data-v-34b49f94="" id="p-${id}" class="li lineRed"><div data-v-34b49f94="">${key}</div></div>`;
      id++;
      let text = '';
      if (key > 4)
        resultData[10] =
          '<div data-v-34b49f94="" class="li"  id="Bigg"><div data-v-34b49f94="">B</div></div>';
      ...
      return (htmls += `
                      <div data-v-a9660e98="" class="c-tc item van-row">
                          ...
                          <div data-v-a9660e98="" class="van-col van-col--16">
                              <div data-v-a9660e98="" class="c-tc goItem c-row">
                                  <!---->
                                  <span data-v-a9660e98="" class="c-row qiu c-row-middle-center"> ${text} </span>
                              </div>
                          </div>
                              ...
                              <div data-v-a9660e98="" class="c-tc goItem">
                                  ...
                                  <span data-v-a9660e98="" class="${
                                    list_orders.amount % 2 == 0
                                      ? 'yellow'
                                      : 'green'
                                  }"> ${list_orders.ketqua} </span>
                              </div>
                          </div>
                          <div data-v-a9660e98="" class="van-col van-col--11">
                              <div data-v-a9660e98="" class="goItem c-row c-tc c-row-center">
                                  <div data-v-a9660e98="" class="c-tc c-row box c-row-center">
                                      <span data-v-a9660e98="" class="li"></span>
                                      ${list_orders.date}
                                  </div>
                              </div>
                          </div>
