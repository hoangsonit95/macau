...
import xsmbController from '../controllers/xsmbController';
...
const initWebRouter = app => {
  ...
  // page list game
  router.get('/list-game', homeController.listGame);
  // page home
  router.get('/', (req, res) => {
  ...
  //xsmb
  router.get('/xsmb', middlewareController, xsmbController.xsmb_page);
  router.post(
    '/api/xsmb/historybet',
    middlewareController,
    xsmbController.betHistory,
  );
  router.post(
    '/api/xsmb/history',
    middlewareController,
    xsmbController.history,
  );
  router.post('/api/xsmb/', middlewareController, xsmbController.cuoc);

  //xsmb admin
  router.get(
    '/admin/manager/xsmbcuoc',
    adminController.middlewareAdminController,
    adminController.adminPageXsmbCuoc,
  );
  router.get(
    '/admin/manager/xsmbrate',
    adminController.middlewareAdminController,
    adminController.adminPageXsmbRate,
  );
  router.get(
    '/admin/manager/xsmbratelist',
    adminController.middlewareAdminController,
    adminController.xsmbRate,
  );
  router.post(
    '/admin/manager/editxsmbrate',
    adminController.middlewareAdminController,
    adminController.editXsmbRate,
  );
  router.post(
    '/api/webapi/admin/xmsbcuoc',
    adminController.middlewareAdminController,
    adminController.listXsmbBet,
  );

  //Sicbo
  router.get('/sicbo/1', middlewareController, sicboController.winGoPage);
  router.post(
    '/api/webapi/sicbo/GetNoaverageEmerdList',
    middlewareController,
    sicboController.listOrderOld,
  );
  router.post(
    '/api/webapi/action/sicbo/join',
    middlewareController,
    sicboController.betSicbo,
  );
  ...
  router.post(
    '/api/webapi/launchgame',
    middlewareController,
    userController.LaunchGame,
  );

  router.get(
    '/api/webapi/listapi/baracat',
    middlewareController,
    userController.listApi,
  );

  router.post(
    '/api/webapi/transfer',
    middlewareController,
    userController.tranfer,
  );
  ...
  router.get(
    '/admin/manager/ratio-k3',
    adminController.middlewareAdminController,
    adminController.adminRatioPageK3,
  ); // get info account
  ...
  router.post(
    ...
    adminController.middlewareAdminController,
    upload.fields([{ name: 'bank' }, { name: 'momo' }]),
  ...
  router.post(
    '/admin/manager/settings/level_vip',
    adminController.middlewareAdminController,
    adminController.settingLevelVip,
  );
  router.post(
  ...
  router.post(
    '/admin/manager/settings/updatetc',
    adminController.middlewareAdminController,
    adminController.settingtc,
  );
  router.post(
  ...
  router.post(
    '/admin/manager/settings/deleteU',
    adminController.middlewareAdminController,
    adminController.settingDeleteUser,
  );
  router.post(
  ...
  router.post(
    '/admin/member/listCapduoi/:phone/:f',
    adminController.middlewareAdminController,
    adminController.listCapduoiF,
  );
  router.post(
  ...
  router.post(
    '/admin/member/betbaccarat/:phone',
    adminController.middlewareAdminController,
    adminController.listBetBaccarat,
  );
  ...
  router.post(
    '/api/webapi/admin/change/bet',
    adminController.middlewareAdminController,
    adminController.changeBet,
  );
  router.post(
  ...
  // sửa tỉ lệ cược
  router.post(
    '/api/webapi/admin/editPrice',
    adminController.middlewareAdminController,
    adminController.editPrice,
  );
  // lấy tỉ lệ cược
  router.post('/api/webapi/getPrice', adminController.getPrice);
